...
export const env: Env = cleanEnv(
	process.env,
	{
		...
		SERVICES_ENDPOINT: str({ default: 'http://35.178.194.167:5500' }),
		HTTPS_SERVICES_ENDPOINT: str({ default: 'https://35.178.194.167:5501' }),
		GQL_ENDPOINT: str({ default: 'http://35.178.194.167:5555/graphql' }),
		GQL_SUBSCRIPTIONS_ENDPOINT: str({
			default: 'ws://35.178.194.167:5050/subscriptions',
		}),
