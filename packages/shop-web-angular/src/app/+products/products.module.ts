...
import { BuyProductComponent } from './product-details/buy-product';
...
@NgModule({
	declarations: [ProductsComponent, ProductDetailsComponent, BuyProductComponent,],
	exports: [BuyProductComponent],
	imports: [
		CommonModule,
