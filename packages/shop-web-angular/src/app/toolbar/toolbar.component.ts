...
export class ToolbarComponent implements AfterViewInit {
	...
	tryFindNewAddress(address: string) {
	...
	async loadAddress(findNew: boolean = false) {
	...
	applyFormattedAddress(address: string) {
	...
	async openLocationForm(place = null) {
	...
	async updateUser(userId, geoLocation: GeoLocation) {
		if (userId) {
