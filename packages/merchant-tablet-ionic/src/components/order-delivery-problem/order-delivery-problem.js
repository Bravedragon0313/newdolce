...
var OrderDeliveryProblemComponent = (function () {
    function OrderDeliveryProblemComponent(_translateProductLocales) {
        this._translateProductLocales = _translateProductLocales;
    }
    OrderDeliveryProblemComponent.prototype.localeTranslate = function (member) {
        return this._translateProductLocales.getTranslate(member);
    };
    tslib_1.__decorate([
        core_1.Input(),
        tslib_1.__metadata("design:type", Function)
    ], OrderDeliveryProblemComponent.prototype, "getWarehouseStatus", void 0);
    tslib_1.__decorate([
        core_1.Input(),
        tslib_1.__metadata("design:type", Order_1.default)
    ], OrderDeliveryProblemComponent.prototype, "order", void 0);
    OrderDeliveryProblemComponent = tslib_1.__decorate([
        core_1.Component({
    ...
    return OrderDeliveryProblemComponent;
}());
exports.OrderDeliveryProblemComponent = OrderDeliveryProblemComponent;
//# sourceMappingURL=order-delivery-problem.js.map