...
var routes = [
    ...
    },
    {
        path: 'help',
        loadChildren: function () {
            return Promise.resolve().then(function () { return tslib_1.__importStar(require('./+help/help.module')); }).then(function (m) { return m.HelpPageModule; });
        },
    },
    {
        path: 'terms-of-use',
    ...
    },
    {
        path: 'privacy',
        loadChildren: function () {
            return Promise.resolve().then(function () { return tslib_1.__importStar(require('./+privacy/privacy.module')); }).then(function (m) { return m.PrivacyPageModule; });
        },
    },
];
