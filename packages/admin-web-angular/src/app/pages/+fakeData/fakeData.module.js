...
let FakeDataModule = class FakeDataModule {
    constructor() {
        console.log('`FakeData` module initialized');
    }
};
FakeDataModule.routes = routes;
FakeDataModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
            ThemeModule,
...
export { FakeDataModule };
//# sourceMappingURL=fakeData.module.js.map