...
let CarrierLocationModule = class CarrierLocationModule {
};
CarrierLocationModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
            ThemeModule,
...
export { CarrierLocationModule };
//# sourceMappingURL=carrier-location.module.js.map