...
let WarehouseOrderModule = class WarehouseOrderModule {
};
WarehouseOrderModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
            ThemeModule,
...
export { WarehouseOrderModule };
//# sourceMappingURL=warehouse-order.module.js.map