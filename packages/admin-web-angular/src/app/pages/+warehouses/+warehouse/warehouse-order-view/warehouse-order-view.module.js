...
let WarehouseOrderViewModule = class WarehouseOrderViewModule {
};
WarehouseOrderViewModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
            ThemeModule,
...
export { WarehouseOrderViewModule };
//# sourceMappingURL=warehouse-order-view.module.js.map