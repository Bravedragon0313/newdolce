...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () => import('app/pages/+sign-in-redirect/sign-in-redirect.module').then((m) => m.SignInRedirectModule),
            },
            {
                path: 'dashboard',
            ...
            {
                path: 'simulation',
                loadChildren: () => import('app/pages/+simulation/simulation.module').then((m) => m.SimulationModule),
            },
            {
                path: 'stores',
                loadChildren: () => import('app/pages/+warehouses/warehouses.module').then((m) => m.WarehousesModule),
            },
            {
                path: 'carriers',
                loadChildren: () => import('app/pages/+carriers/carriers.module').then((m) => m.CarriersModule),
            },
            {
                path: 'setup',
                loadChildren: () => import('app/pages/+setup/setup.module').then((m) => m.SetupModule),
            },
            {
                path: 'generate-initial-data',
                loadChildren: () => import('app/pages/+fakeData/fakeData.module').then((m) => m.FakeDataModule),
            },
            {
                path: 'devices',
                loadChildren: () => import('app/pages/+device/device.module').then((m) => m.DeviceModule),
            },
            {
                path: 'customers',
