...
let ContactInfoFormComponent = class ContactInfoFormComponent {
    ...
    setValue(contactInfo) {
        ...
        if (contactInfo.forwardOrdersUsing) {
            this.forwardingEmail = contactInfo.forwardOrdersUsing.includes(ForwardOrdersMethod.Email);
            this.forwardingPhone = contactInfo.forwardOrdersUsing.includes(ForwardOrdersMethod.Phone);
        }
    }
    get contactEmail() {
    ...
    forwardingPhoneChange() {
        ...
        forwardOrdersUsingArr = forwardOrdersUsingArr.filter((v) => v !== ForwardOrdersMethod.Phone);
    ...
    forwardingEmailChange() {
        ...
        let forwardOrdersUsingArr = this.forwardOrdersUsing.value || [];
        forwardOrdersUsingArr = forwardOrdersUsingArr.filter((v) => v !== ForwardOrdersMethod.Email);
...
ContactInfoFormComponent = __decorate([
    Component({
        selector: 'ea-warehouse-contact-info-form',
        templateUrl: 'contact-info-form.component.html',
    })
], ContactInfoFormComponent);
export { ContactInfoFormComponent };
//# sourceMappingURL=contact-info-form.component.js.map