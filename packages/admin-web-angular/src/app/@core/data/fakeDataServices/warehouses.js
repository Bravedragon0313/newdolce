...
let FakeDataWarehouses = class FakeDataWarehouses {
    constructor() {
    ...
    _getRandomDateRange(yearsRange = 6) {
        const now = new Date();
        ...
        const storeCreatedAt = new Date(storeYear, storeMonth, storeDate, storeHours, storeMinutes);
...
FakeDataWarehouses = __decorate([
    Injectable()
], FakeDataWarehouses);
export default FakeDataWarehouses;
