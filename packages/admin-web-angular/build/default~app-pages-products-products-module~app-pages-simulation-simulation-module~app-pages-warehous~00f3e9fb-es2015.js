...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ɵb", function() { return OffClickDirective; });
...
AutofocusDirective.propDecorators = {
    "ssAutofocus": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] },],
};
...
const /** @type {?} */ MULTISELECT_VALUE_ACCESSOR = {
    ...
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(() => MultiselectDropdownComponent),
    multi: true,
};
class MultiselectDropdownComponent {
    ...
    ngOnInit() {
        ...
        this.filterControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroyed$)).subscribe(() => {
...
MultiselectDropdownComponent.propDecorators = {
    ...
    "disabledSelection": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] },],
    "searchFunction": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] },],
    "selectionLimitReached": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] },],
    "dropdownClosed": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] },],
    "dropdownOpened": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] },],
    "onAdded": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] },],
    "onRemoved": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] },],
...
OffClickDirective.propDecorators = {
    "onOffClick": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"], args: ['offClick',] },],
    ...
    "onDocumentTouch": [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["HostListener"], args: ['document:touchstart', ['$event'],] },],
};
...
//# sourceMappingURL=default~app-pages-products-products-module~app-pages-simulation-simulation-module~app-pages-warehous~00f3e9fb-es2015.js.map