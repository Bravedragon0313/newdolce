...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~app-pages-products-products-module~app-pages-simulation-simulation-module~app-pages-warehous~00f3e9fb"], {
  /***/
  ...
  /*! exports provided: MultiSelectSearchFilter, MultiselectDropdownModule, MultiselectDropdownComponent, ɵa, ɵb */

  /***/
  function node_modulesAngular2DropdownMultiselectFesm2015Angular2DropdownMultiselectJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MultiselectDropdownModule", function () {
    ...
    var MultiSelectSearchFilter = /*#__PURE__*/function () {
      ...
      _createClass(MultiSelectSearchFilter, [{
        ...
        value: function transform(options) {
          ...
          var searchFunction = arguments.length > 4 ? arguments[4] : undefined;
          ...
          var
          /** @type {?} */
          filteredOpts = this._searchCache.hasOwnProperty(str) ? this._searchCache[str] : this._doSearch(options, str, limit, searchFunction);
          var
          /** @type {?} */
          isUnderLimit = options.length <= limit;
        ...
        key: "_getSubsetOptions",
        value: function _getSubsetOptions(options, prevOptions, prevSearchStr) {
          var
          /** @type {?} */
          prevInclusiveOrIdx = this._searchCacheInclusive[prevSearchStr];
          ...
          if (prevInclusiveOrIdx === true) {
            ...
            return [].concat(_toConsumableArray(prevOptions), _toConsumableArray(options.slice(prevInclusiveOrIdx)));
          }
        ...
        key: "_doSearch",
        value: function _doSearch(options, str, limit, searchFunction) {
          var
          /** @type {?} */
          prevStr = str.slice(0, -1);
          var
          /** @type {?} */
          prevResults = this._searchCache[prevStr];
          var
          /** @type {?} */
          prevResultShift = this._prevSkippedItems[prevStr] || 0;
          ...
          var
          /** @type {?} */
          maxFound = limit > 0 ? Math.min(limit, optsLength) : optsLength;
          var
          /** @type {?} */
          regexp = searchFunction(str);
          var
          /** @type {?} */
          filteredOpts = [];
          var
          ...
          var
          /** @type {?} */
          doesOptionMatch = function doesOptionMatch(option) {
          ...
          var
          /** @type {?} */
          notFoundFn = prevResults ? function () {
            return removedFromPrevResult++;
          } : function () {};
          ...
          for (; i < optsLength && founded < maxFound; ++i) {
            ...
            var
            /** @type {?} */
            directMatch = doesOptionMatch(option);
            ...
            if (typeof option.parentId === 'undefined') {
              var
              /** @type {?} */
              childrenMatch = getChildren(option).some(doesOptionMatch);
            ...
            if (typeof option.parentId !== 'undefined') {
              var
              /** @type {?} */
              parentMatch = doesOptionMatch(getParent(option));
          ...
          var
          /** @type {?} */
          totalIterations = i + prevResultShift;
    ...
    var AutofocusDirective = /*#__PURE__*/function () {
      ...
      _createClass(AutofocusDirective, [{
        ...
        value: function ngOnChanges(changes) {
          var
          /** @type {?} */
          ssAutofocusChange = changes["ssAutofocus"];
    ...
    var MultiselectDropdownComponent = /*#__PURE__*/function () {
      ...
      _createClass(MultiselectDropdownComponent, [{
        ...
        value: function ngOnChanges(changes) {
          ...
          if (changes['options']) {
            ...
            if (this.settings.isLazyLoad && this.settings.selectAddedValues && changes["options"].previousValue) {
              var
              /** @type {?} */
              addedValues = changes["options"].currentValue.filter(function (value) {
                return _this2.loadedValueIds.indexOf(value.id) === -1;
              });
              ...
              if (this.checkAllStatus) {
                ...
                this.checkAllSearchRegister.forEach(function (searchValue) {
                  return _this2.addChecks(_this2.applyFilters(addedValues, searchValue));
                });
              }
            }
        ...
        key: "fireModelChange",
        value: function fireModelChange() {
        ...
        value: function ngDoCheck() {
          var
          /** @type {?} */
          changes = this.differ.diff(this.model);
        ...
        value: function validate(_c) {
          ...
          if (this.options.filter(function (o) {
            return _this3.model.indexOf(o.id) && !o.disabled;
          }).length === 0) {
            return {
              selection: {
                valid: false
        ...
        value: function setSelected(_event, option) {
          ...
          setTimeout(function () {
            _this4.maybeStopPropagation(_event);

            _this4.maybePreventDefault(_event);

            var
            /** @type {?} */
            index = _this4.model.indexOf(option.id);

            var
            /** @type {?} */
            isAtSelectionLimit = _this4.settings.selectionLimit > 0 && _this4.model.length >= _this4.settings.selectionLimit;

            var
            /** @type {?} */
            removeItem = function removeItem(idx, id) {
              _this4.model.splice(idx, 1);

              _this4.onRemoved.emit(id);

              if (_this4.settings.isLazyLoad && _this4.lazyLoadOptions.some(function (val) {
                return val.id === id;
              })) {
                _this4.lazyLoadOptions.splice(_this4.lazyLoadOptions.indexOf(_this4.lazyLoadOptions.find(function (val) {
                  return val.id === id;
                })), 1);
              }
            };
            ...
            if (index > -1) {
              if (_this4.settings.minSelectionLimit === undefined || _this4.numSelected > _this4.settings.minSelectionLimit) {
                removeItem(index, option.id);
              }

              var
              /** @type {?} */
              parentIndex = option.parentId && _this4.model.indexOf(option.parentId);

              if (parentIndex > -1) {
                removeItem(parentIndex, option.parentId);
              } else if (_this4.parents.indexOf(option.id) > -1) {
                _this4.options.filter(function (child) {
                  return _this4.model.indexOf(child.id) > -1 && child.parentId === option.id;
                }).forEach(function (child) {
                  return removeItem(_this4.model.indexOf(child.id), child.id);
                });
              }
            } else if (isAtSelectionLimit && !_this4.settings.autoUnselect) {
              _this4.selectionLimitReached.emit(_this4.model.length);
              ...
              addItem = function addItem(id) {
                _this4.model.push(id);

                _this4.onAdded.emit(id);

                if (_this4.settings.isLazyLoad && !_this4.lazyLoadOptions.some(function (val) {
                  return val.id === id;
                })) {
                  _this4.lazyLoadOptions.push(option);
                }
              };
              ...
              if (!isAtSelectionLimit) {
                if (option.parentId && !_this4.settings.ignoreLabels) {
                  var
                  /** @type {?} */
                  children = _this4.options.filter(function (child) {
                    return child.id !== option.id && child.parentId === option.parentId;
                  });

                  if (children.every(function (child) {
                    return _this4.model.indexOf(child.id) > -1;
                  })) {
                  ...
                  var
                  /** @type {?} */
                  _children = _this4.options.filter(function (child) {
                    return _this4.model.indexOf(child.id) < 0 && child.parentId === option.id;
                  });
                ...
                removeItem(0, _this4.model[0]);
              }
            }

            if (_this4.settings.closeOnSelect) {
              _this4.toggleDropdown();
            }

            _this4.model = _this4.model.slice();

            _this4.fireModelChange();
          }, 0);
        }
        /**
         * @return {?}
        ...
        value: function updateNumSelected() {
          ...
          this.numSelected = this.model.filter(function (id) {
            return _this5.parents.indexOf(id) < 0;
          }).length || 0;
        }
        /**
         * @return {?}
        ...
        value: function updateTitle() {
          ...
          var
          /** @type {?} */
          numSelectedOptions = this.options.length;

          if (this.settings.ignoreLabels) {
            numSelectedOptions = this.options.filter(function (option) {
          ...
          if (this.numSelected === 0 || this.settings.fixedTitle) {
            ...
            var
            /** @type {?} */
            useOptions = this.settings.isLazyLoad && this.lazyLoadOptions.length ? this.lazyLoadOptions : this.options;
            var
            /** @type {?} */
            titleSelections;
            ...
            if (this.settings.maintainSelectionOrderInTitle) {
              var
              /** @type {?} */
              optionIds = useOptions.map(function (selectOption, idx) {
                return selectOption.id;
              });
              titleSelections = this.model.map(function (selectedId) {
                return optionIds.indexOf(selectedId);
              }).filter(function (optionIndex) {
                return optionIndex > -1;
              }).map(function (optionIndex) {
                return useOptions[optionIndex];
              });
            } else {
              titleSelections = useOptions.filter(function (option) {
                return _this6.model.indexOf(option.id) > -1;
              });
            }

            this.title = titleSelections.map(function (option) {
              return option.name;
            }).join(', ');
          } else {
        ...
        value: function addChecks(options) {
          ...
          var
          /** @type {?} */
          checkedOptions = options.filter(function (option) {
            if (!option.disabled && _this7.model.indexOf(option.id) === -1 && !(_this7.settings.ignoreLabels && option.isLabel)) {
              _this7.onAdded.emit(option.id);
        ...
        value: function uncheckAll() {
          ...
          if (!this.disabledSelection) {
            var
            /** @type {?} */
            checkedOptions = this.model;
            var
            /** @type {?} */
            unCheckedOptions = !this.searchFilterApplied() ? this.model : this.filteredOptions.map(function (option) {
              return option.id;
            }); // set unchecked options only to the ones that were checked

            unCheckedOptions = checkedOptions.filter(function (item) {
              return unCheckedOptions.indexOf(item) > -1;
            });
            this.model = this.model.filter(function (id) {
              if (unCheckedOptions.indexOf(id) < 0 && _this8.settings.minSelectionLimit === undefined || unCheckedOptions.indexOf(id) < _this8.settings.minSelectionLimit) {
                return true;
              } else {
                _this8.onRemoved.emit(id);
              ...
              if (this.searchFilterApplied()) {
                if (this.checkAllSearchRegister.has(this.filterControl.value)) {
                  ...
                  this.checkAllSearchRegister.forEach(function (searchTerm) {
                    var
                    /** @type {?} */
                    filterOptions = this.applyFilters(this.options.filter(function (option) {
                      return unCheckedOptions.indexOf(option.id) > -1;
                    }), searchTerm);
        ...
        value: function isCheckboxDisabled(option) {
        ...
        value: function checkScrollPosition(ev) {
          ...
          var
          /** @type {?} */
          scrollElementHeight = ev.target.clientHeight;
          var
          /** @type {?} */
          roundingPixel = 1;
          var
        ...
        value: function checkScrollPropagation(ev, element) {
          ...
          var
          /** @type {?} */
          scrollElementHeight = element.clientHeight;
        ...
        key: "trackById",
        value: function trackById(idx, selectOption) {
          return selectOption.id;
        }
        /**
         * @return {?}
        ...
        key: "focusItem",
        value: function focusItem(dir, e) {
          if (!this.isVisible) {
            return;
          }
          ...
          var
          /** @type {?} */
          idx = this.filteredOptions.indexOf(this.focusedItem);
          ...
          var
          /** @type {?} */
          newIdx = nextIdx < 0 ? this.filteredOptions.length - 1 : nextIdx % this.filteredOptions.length;
        ...
        key: "maybePreventDefault",
        value: function maybePreventDefault(e) {
        ...
        key: "maybeStopPropagation",
        value: function maybeStopPropagation(e) {
    ...
    var OffClickDirective = /*#__PURE__*/function () {
      function OffClickDirective() {
        _classCallCheck(this, OffClickDirective);
      ...
      _createClass(OffClickDirective, [{
        key: "onClick",
        ...
        key: "onDocumentTouch",
        value: function onDocumentTouch(event) {
    ...
    var MultiselectDropdownModule = function MultiselectDropdownModule() {
      _classCallCheck(this, MultiselectDropdownModule);
    };

    MultiselectDropdownModule.decorators = [{
      type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
      args: [{
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"]],
        exports: [MultiselectDropdownComponent, MultiSelectSearchFilter],
        declarations: [MultiselectDropdownComponent, MultiSelectSearchFilter, AutofocusDirective, OffClickDirective]
      }]
    }];
    /**
     * @fileoverview added by tsickle
...
//# sourceMappingURL=default~app-pages-products-products-module~app-pages-simulation-simulation-module~app-pages-warehous~00f3e9fb-es5.js.map