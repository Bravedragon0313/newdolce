...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~app-pages-customers-customers-module~app-pages-orders-orders-module~app-pages-products-produ~ffbf4b96"], {
  ...
  /***/
  function node_modulesNgxHighlightjsFesm2015NgxHighlightjsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var HighlightJS = /*#__PURE__*/function () {
      ...
      _createClass(HighlightJS, [{
        ...
        value: function _loadScript() {
          ...
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(promise).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function () {
        ...
        value: function _initHLJS() {
          ...
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])({}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () {
        ...
        key: "isReady",
        get: function get() {
          return this._isReady$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (isReady) {
            return isReady;
    ...
    HighlightJS.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["defineInjectable"])({
      factory: function HighlightJS_Factory() {
        return new HighlightJS(Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["inject"])(OPTIONS, 8), Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["inject"])(_angular_common__WEBPACK_IMPORTED_MODULE_1__["DOCUMENT"]));
      },
      token: HighlightJS,
      providedIn: "root"
    });
    ...
    var HighlightDirective = /*#__PURE__*/function () {
      ...
      _createClass(HighlightDirective, [{
        ...
        value: function ngOnInit() {
          ...
          if (!this.code && this.hljs.options.auto) {
            this.hljs.isReady.subscribe(function () {
              _this4.highlightTextContent();
              /** Highlight when text content changes */


              _this4.domObs = new MutationObserver(function () {
                return _this4.highlightTextContent();
              });

              _this4.domObs.observe(_this4.el, {
                childList: true,
                subtree: true
              });
            });
        ...
        value: function highlightChildren(el, selector) {
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(codeElements).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (code) {
            return code.childNodes.length === 1 && code.childNodes[0].nodeName === '#text';
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (codeElement) {
            return _this5.highlightElement(codeElement, codeElement.innerText.trim());
        ...
        set: function set(code) {
          ...
          this.code = code;
          this.hljs.isReady.subscribe(function () {
            return _this6.highlightElement(_this6.el, code);
          });
        }
      }]);
...
//# sourceMappingURL=default~app-pages-customers-customers-module~app-pages-orders-orders-module~app-pages-products-produ~ffbf4b96-es5.js.map